...
import com.fina.kuis.api.RestApi;
import com.fina.kuis.api.RetroServer;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        stok = (EditText) findViewById(R.id.edt_stok);
        ...
        btnsave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (snama.isEmpty() ) {
                    ...
                    stok.setError("stok perlu di isi");}
                 else {
                    RestApi api =
                            RetroServer.getClient().create(RestApi.class);
                    Call<ResponseModel> sendbio =
                            api.sendBiodata(snama,sstok);
